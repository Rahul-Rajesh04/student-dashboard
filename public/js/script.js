...
document.addEventListener('DOMContentLoaded', () => {
        ...
        courses: [
            {
                ...
                progress: 75,
                grade: "A",
                syllabus: `<h4>Course Description</h4><p>This course covers the fundamentals of data structures and algorithms, including arrays, linked lists, stacks, queues, trees, and graphs. Students will learn to analyze algorithm efficiency and apply these concepts to solve complex problems.</p><h4>Grading Policy</h4><ul><li>Assignments: 30%</li><li>Quizzes: 20%</li><li>Midterm Exam: 25%</li><li>Final Exam: 25%</li></ul>`,
                grades: [
            ...
            },
            {
                ...
                progress: 50,
                grade: "A-",
                syllabus: `<h4>Course Description</h4><p>An introduction to the field of machine learning, covering topics like supervised and unsupervised learning, regression, classification, and clustering.</p><h4>Grading Policy</h4><ul><li>Lab Submissions: 40%</li><li>Project: 30%</li><li>Final Exam: 30%</li></ul>`,
                grades: [
            ...
            },
            {
                ...
                progress: 82,
                grade: "B",
                syllabus: `<h4>Course Description</h4><p>This course provides a comprehensive overview of database management systems. Topics include data models, relational algebra, SQL, database design, and transaction management.</p><h4>Grading Policy</h4><ul><li>Assignments & Labs: 50%</li><li>Midterm Exam: 25%</li><li>Final Project: 25%</li></ul>`,
                grades: [
            ...
            },
            {
                ...
                progress: 95,
                grade: "O",
                syllabus: `<h4>Course Description</h4><p>Explores ethical issues and decision-making in professional contexts, with a focus on engineering and technology.</p><h4>Grading Policy</h4><ul><li>Case Study Analyses: 60%</li><li>Final Report: 40%</li></ul>`,
                grades: [
    ...
    async function populateUserData() {
        // ... (this function's body remains the same)
    }
    ...
    async function renderProfilePage() {
        ...
        cancelDeleteBtn2.addEventListener('click', closeModal);
